...
const NewsListCard = (props: NewsListCardProps) => {
  ...
  return (
    <Card className="news-link-card-container" square elevation={0}>
      <Link href={link || ""} underline="none">
        <CardActionArea className="news-link-card-action-area-button">
          <div className="news-link-card-image-container">
            <CardMedia
              className="news-link-card-image"
              component="img"
